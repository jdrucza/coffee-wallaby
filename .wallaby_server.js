...
module.exports = function (wallaby) {
  ...
  return {
    ...
    files: [
      './**/*.coffee',
      {pattern: './**/*.spec.coffee', ignore:true},
      {pattern: relativeMeteorAppPath + '/.meteor/**/*', ignore: true}, // don't think this is needed but neither should it hurt
    ],

    tests: [
      // './imports/**/*.spec.coffee',
      './imports/testSetup.spec.coffee'
    ],
    // compilers: {
      // '**/*.@(js|jsx)': wallaby.compilers.babel(),
      // NOTE: I suspect something needs to be done to tell wallaby to use meteor's coffeescript transpiler...
    // },
